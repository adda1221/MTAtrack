...
# from lib.config.MAtrack_st1.config import cfg, update_config_from_file
# from lib.models.MAtrack.MAtrack_s import build_MAtracks
...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='MAtrack_s', choices=['MAtrack_s', 'MAtrack_st2'],
...
if __name__ == "__main__":
    ...
    # Compute the Flops and Params of our MAtrack-S model
    args = parse_args()
    '''update cfg'''
    ...
    '''import MAtrack network module'''
    model_module = importlib.import_module('lib.models.MAtrack')
    if args.script == "MAtrack_s":
        model_constructor = model_module.build_MAtracks
    ...
    elif args.script == "MAtrack_st2":
        model_constructor = model_module.build_MAtrackst
        model = model_constructor(cfg)
        # get the template and search
